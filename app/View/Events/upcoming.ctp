<div class="events index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('starttime', 'Starts on'); ?></th>
			<th><?php echo $this->Paginator->sort('endtime', 'Ends at'); ?></th>
	</tr>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('All Events'), array('controller' => 'events', 'action' => 'index')); ?> </li>
	</ul>
</div>